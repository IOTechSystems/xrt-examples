#!/bin/bash
# Hidden test script for bacnet-ip device service example
...
# Topics
REQUEST_RESPONSE_TOPIC="spBv1.0/${SPARKPLUG_GROUP}/RESPONSE/${SPARKPLUG_NODE}/bacnet_ip"
DDATA_TOPIC="spBv1.0/${SPARKPLUG_GROUP}/DDATA/${SPARKPLUG_NODE}/+"
DACK_TOPIC="spBv1.0/${SPARKPLUG_GROUP}/DACK/${SPARKPLUG_NODE}/+"

TIMEOUT=5

echo "Running bacnet-ip device service command tests..."
