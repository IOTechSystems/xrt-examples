...
docker run --rm -d --name=bacnet-mstp-sim -e RUN_MODE=MSTP ${SPARKPLUG_GROUP}sys/bacnet-sim:2.0 --script /example-scripts/device-service-example.lua --instance 1234 --name BacnetSimulator
sleep 2
