...
For more information about the Device Service please review the [OPC-UA Device Service](https://docs.iotechsys.com/edge-connect33/xrt/devices/opc-ua.html) documentation.

## Getting Started

### **Run the simulator**

_For more information about the OPC-UA device simulator, see [OPC-UA Simulator](https://docs.iotechsys.com/edge-connect33/xrt/simulators/opc-ua/overview.html)._
...
Subscriptions are specific to the OPC-UA device service. You can read more about them [here](https://docs.iotechsys.com/edge-connect33/xrt/devices/opc-ua.html#opc-ua-subscriptions).
