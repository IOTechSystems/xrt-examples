...
public:
  ...
  {
    iot_log_trace(logger, "bus_create_list_msg");
    iot_data_t* map = iot_data_alloc_map(IOT_DATA_STRING);
    iot_data_string_map_add(map, "client", iot_data_alloc_string("xrt-lib", IOT_DATA_REF));
    iot_data_string_map_add(map, "request_id", iot_data_alloc_string("0eb23c34-b38a-4e46-96ac-d1fb2b8c5597", IOT_DATA_REF));
    iot_data_string_map_add(map, "op", iot_data_alloc_string("device:list", IOT_DATA_REF));
    iot_data_string_map_add(map, "type", iot_data_alloc_string("xrt.request:1.0", IOT_DATA_REF));
    return map;
  }
