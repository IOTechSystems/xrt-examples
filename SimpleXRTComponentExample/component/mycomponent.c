...
extern my_component_t * my_component_alloc (iot_logger_t * logger)
{
  ...
  iot_component_init (&mycomp->component, mycomponent_factory (), (iot_component_start_fn_t) my_component_start, (iot_component_stop_fn_t) my_component_stop);
